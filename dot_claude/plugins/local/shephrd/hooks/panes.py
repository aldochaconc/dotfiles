...
def selftest():
    ...
    with tempfile.TemporaryDirectory() as d:
        ...
        assert p.exists()
        assert read("w1R:p8", d)["reports_to"] == "lead"
        ...
        write("w1T:p1", "os-reports_to", "", directory=d)
        assert resolve({"HERDR_PANE_ID": "w1T:p1"}, d)["reports_to"] == ""
    ...
    with tempfile.TemporaryDirectory() as d:
        ...
        write("w1T:p1", "os-reports_to", "", "dotfiles", god=True, directory=d)
        ...
        assert resolve({"HERDR_PANE_ID": "w1R:p1"}, d)["role"] == "shephrd"
